                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button class="boton boton-editar"><a href="<%= contextPath %>/UsuarioController?menu=Usuarios&accion=Editar&idUsuario=<%= u.getIdUsuario()%>">Editar</a></button>
                                <button class="boton boton-eliminar"><a href="<%= contextPath %>/UsuarioController?menu=Usuarios&accion=Eliminar&idUsuario=<%= u.getIdUsuario()%>">Eliminar</button></td>
                        </tr>
                        <%
                            }
                        } else {
